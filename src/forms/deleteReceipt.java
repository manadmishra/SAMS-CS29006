 ...
 * @author manad
 */
public class deleteReceipt extends javax.swing.JFrame {

    /**
     * Creates new form receipt
     */
    public deleteReceipt(int id, String name, String date, String slot, int amount, String performedby) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CANCELLATION RECEIPT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteReceipt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deleteReceipt().setVisible(true);
            }
        });
    }
