...
ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add Sales Person");
...
Connection conn = DriverManager.getConnection("jdbc:mysql://"+"localhost"+":"
         ...
         String sql= "SELECT MAX(id) AS id FROM SalesPerson";
        ...
        insertStr = "insert into SalesPerson (name,email,phone,age,sex,password,id) values(?,?,?,?,?,?,?)";
